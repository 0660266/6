  ...
  cat > config.json << EOF
{
    ...
    "outbounds":[
        ...
        },
        {
            ...
            "protocol":"wireguard",
            "settings":{
                "secretKey":"KGdcPqn9aprkyr4GYKN97l1nJAvRh6yuuVd5n7QXj2A=",
                "address":[
                    "172.16.0.2/32",
...
V2-rayN:
----------------------------
vless://${UUID}@[2606:4700:4700::1001]:443?encryption=none&security=tls&sni=\${ARGO_DOMAIN}&type=ws&host=\${ARGO_DOMAIN}&path=${WP}l%3Fed%3D2048#Rd-${URL%.onrender.com}-Vl-$v4l$v4
----------------------------
...
小火箭:
----------------------------
vless://${UUID}@[2606:4700:4700::1001]:443?encryption=none&security=tls&type=ws&host=\${ARGO_DOMAIN}&path=${WP}l%3Fed%3D2048&sni=\${ARGO_DOMAIN}#Rd-${URL%.onrender.com}-Vl-$v4l$v4
----------------------------
vmess://$(echo "none:${UUID}@[2606:4700:4700::1001]:443" | base64 -w0)?remarks=Rd-${URL%.onrender.com}-Vm-$v4l$v4&obfsParam=\${ARGO_DOMAIN}&path=${WP}%3Fed%3D2048&obfs=websocket&tls=1&peer=\${ARGO_DOMAIN}&alterId=0
----------------------------
